...
-- Dumping database structure for companyusers
CREATE DATABASE IF NOT EXISTS `companyusers` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `companyusers`;

-- Dumping structure for table companyusers.department
...
-- Dumping data for table companyusers.department: ~13 rows (approximately)
...
-- Dumping structure for table companyusers.location
...
-- Dumping data for table companyusers.location: ~4 rows (approximately)
...
-- Dumping structure for table companyusers.personnel
...
-- Dumping data for table companyusers.personnel: ~100 rows (approximately)
